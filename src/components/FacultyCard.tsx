...
const FacultyCard: React.FC<FacultyCardProps> = ({
  ...
  return (
    <div className="group relative flex h-full flex-col rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-blue-300 hover:shadow-lg">
      {/* Header */}
      ...
      {/* Rating Section - Positioned at bottom */}
      <div
