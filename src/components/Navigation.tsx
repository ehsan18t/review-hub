              ...
              {currentUser && (
                <>
                  ...
                  {currentUser.role === "student" && (
                    <div className="flex items-center space-x-1 rounded-full bg-emerald-600 px-2 py-1.5 text-xs font-semibold text-white shadow-sm transition-all duration-200 hover:scale-105 hover:bg-emerald-700 hover:shadow-md sm:space-x-2 sm:px-4 sm:py-2 sm:text-sm">
